...
void sequential_mps_interval_memorized_alt(double*,int,double*,double*,int*,memo**);

void sequential_mps_iterate_reverse_mps_alt(double*,int,double*,double*,int*,memo**);
