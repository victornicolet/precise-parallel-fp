...
void test1(){
    ...
    typedef boost::property<boost::vertex_index_t, int> PredProperty;
    ...
    // Properties
    property_map<Graph, edge_weight_t>::type w = get(edge_weight,g);
    property_map<Graph, vertex_index_t>::type p = get(vertex_index,g);
    ...
    //bellman_ford_shortest_paths(g,0,w,p);
}
