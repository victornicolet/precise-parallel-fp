...
/* This function compares the runtime of the different  alternative sequential mps implementations */
void runtime_comparison_sequential_alt(){
    ...
    if(argc >= 1){
        ...
        switch (a){
            ...
            case 2 :
                ...
                break;
            case 3 :
                runtime_comparison_sequential_alt();
                break;
            case 4 :
