...
results = []
with open("Plots/plot4.csv", "rb") as csvfile:
...
pypl.plot(results[0],results[3],label="Mss with superaccumulators")
...
pypl.title("Computation time for mss as a function of the dynamic range");
#pypl.show()
pypl.savefig("Plots/lazymssseq.jpg");
