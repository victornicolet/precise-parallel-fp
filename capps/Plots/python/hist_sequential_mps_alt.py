...
pypl.bar([0.75,2],[results[5][0],results[5][0]], color = 'blue', width=barw/2,label='Interval Arithmetic')
...
pypl.bar([1.375,2.625],[results[16][0],results[17][0]],color='green', width=barw/2,label='Exact Computation FPE')
